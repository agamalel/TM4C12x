...
#define TIMER_TAMR_PERIODIC			0x00000002  // Priodic mode
#define TIMER_CFG_16_BIT        0x00000004  // 16-bit timer configuration
#define TIMER_TAMR_TACMR				0x0					// Edge Count Mode
#define TIMER_TAMR_TAAMS				0x00000008  // PWM mode enable
...
// Duty Cycle is the amount of cycles to stay high DutyCycle = High / Period
void Timer0APWM_RightWheelInit(unsigned short Period, unsigned short High)
{
	...
	//GPIO_PORTB_DIR_R|= 0x40;    // PB6 Output Pin
	...
	TIMER0_TAMR_R|= TIMER_TAMR_TAAMS | TIMER_TAMR_TACMR | TIMER_TAMR_PERIODIC; // Periodic, PWM enabled, Edge Count mode
...
// Change DutyCycle for Right Wheel
// Timer0A, 16-Bit
void Timer0APWM_RightWheelDutyCycle(unsigned short High)
{
		TIMER0_TAMATCHR_R= TIMER0_TAMATCHR_R - High;   // change the low period of the square wave 
}
