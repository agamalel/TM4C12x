...
void Init_TemperatureSensor(unsigned long SamplePeriod) 
{
	...
	ADC0_PP_R= (ADC0_PP_R & 0) | 0x00200000 | 0x00000010 | 0x00000001; // Resolution is 2, temperature sensor is on, 125k sample/sec
	ADC0_EMUX_R|= 0x5000; // Timer is the trigger source
	ADC0_SSCTL3_R= (ADC0_SSCTL3_R & 0) | ADC_SSCLT3_TS | ADC_SSCTL3_IM | ADC_SSCTL3_END;  // Enable Temperature sensor, Interrupts and END0. No differential sampling mode 
...
{
	Temp= 147.5 - ((75 * ADC0_SSFIFO3_R * 3.3) / 4096);
